...
% ===== TAUTAN ===============================================================
% Seluruh tabel di bawah membaca makro ini; ubah di sini kalau alamatnya pindah.

% Repositori GitHub penelitian.
\newcommand{\tautanRepo}{https://github.com/stephenprasetyachrismawan/openmrs-tfidf-ngram}

% Stack Docker OpenMRS Reference Application (klon hulu).
\newcommand{\tautanDistro}{https://github.com/openmrs/openmrs-distro-referenceapplication}

% Google Drive — kumpulan PPT progress dan dokumen demo aplikasi.
\newcommand{\tautanPPT}{https://drive.google.com/drive/folders/1TJqGHXuPlr9W1WJoZRUFE8TqpMC2NnWo?usp=sharing}

% Alamat lokal instalasi OpenMRS hasil pemasangan.
\newcommand{\tautanHalaman}{http://127.0.0.1/openmrs/spa/unified-search}
\newcommand{\tautanRest}{http://127.0.0.1/openmrs/ws/rest/v1/unifiedsearch}
...
\textbf{Kumpulan PPT Progress \& Demo Aplikasi} \newline
{\footnotesize Slide laporan kemajuan penelitian dan berkas demo aplikasi
berada dalam satu folder Google Drive.} &
\url{\tautanPPT} \\
...
\texttt{git clone}
\href{\tautanRepo}{\texttt{https://github.com/} \newline
...
\texttt{git clone}
\href{\tautanDistro}{\texttt{https://github.com/} \newline
...
8 & Buka di peramban &
\href{\tautanHalaman}{\texttt{http://127.0.0.1/openmrs/spa/} \newline
...
\noindent
Basis alamat: \href{\tautanRest}{\texttt{http://127.0.0.1/openmrs/ws/rest/v1/unifiedsearch}}
